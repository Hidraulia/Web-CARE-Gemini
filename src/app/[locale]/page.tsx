    ...
    <>
      <section className={styles.hero} style={{ overflow: "hidden", position: "relative" }}>
        ...
        >
          ...
          >
            <img src="/images-slider/img-slide-3.jpg" alt="Mobiliario de Diseño" loading="eager" style={{width: '100%', height: '100%', objectFit: 'cover', filter: 'brightness(0.5) contrast(1.1) saturate(0.8)'}} />
          </motion.div>
        </motion.div>
      ...
      <section className={styles.section}>
        ...
        >
          ...
          <motion.div className={styles.card} variants={fadeIn}>
            <img src="/img/company.jpg" alt="B2B" loading="lazy" className={styles.cardImage} />
            <div className={styles.cardOverlay}>
              ...
              <Link href={`/${locale}/auth/login?role=b2b`} className={styles.cardLink}>Acceso Partners</Link>
            </div>
          </motion.div>

          {/* Interioristas */}
          <motion.div className={styles.card} variants={fadeIn}>
            <img src="/img/projects/img2.jpg" alt="Arquitectos" loading="lazy" className={styles.cardImage} />
            <div className={styles.cardOverlay}>
              ...
              <Link href={`/${locale}/auth/login?role=interiorista`} className={styles.cardLink}>Centro Técnico</Link>
            </div>
          </motion.div>

          {/* B2C Selectivo */}
          <motion.div className={styles.card} variants={fadeIn}>
            <img src="/img/vestidor.jpg" alt="B2C" loading="lazy" className={styles.cardImage} />
            <div className={styles.cardOverlay}>
              ...
              <Link href={`/${locale}/auth/login?role=b2c`} className={styles.cardLink}>Área Cliente</Link>
            </div>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section className={styles.section} style={{ backgroundColor: 'var(--color-bg-dark)', color: '#fff', borderRadius: '4px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            >
               <img src="/img/imgservice.jpg" alt="Fábrica" loading="lazy" style={{ width: '100%', height: '100%', objectFit: 'cover', filter: 'grayscale(0.3) contrast(1.1)' }} />
